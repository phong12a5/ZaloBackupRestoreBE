...
public class AuthService {
    ...
    public void register(RegisterRequest registerRequest) {
        ...
        // 1. Create and save user in auth-service database
        ...
        // Note: auth-service User model doesn't have fullname, which is fine.

        User savedUser = userRepository.save(newUser);

        // 2. Prepare user data for user-service (including fullname)
